						...
						<div class="card card-outline card-info bg-primary">
							...
							<div class="card-footer">
								<div class="d-flex justify-content-end w-100">
									<button class="btn btn-sm btn-green btn-flat bg-green mx-1" form="manage-criteria">Save</button>
									<button class="btn btn-sm btn-flat btn-secondary bg-gradient-secondary mx-1" form="manage-criteria" type="reset">Clear</button>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="callout callout-info bg-primary">
							...
							<div class="d-flex justify-content-between w-100">
								<label for=""><b>Criteria List</b></label>
									<button class="btn btn-sm btn-green btn-flat bg-green mx-1" form="order-criteria">Save Order</button>
							</div>
							<hr>
