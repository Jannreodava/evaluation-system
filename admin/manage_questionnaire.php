			...
			<div class="card card-info card-primary">
				...
				<div class="card-footer bg-primary">
					<div class="d-flex justify-content-end w-100">
						...
						<button class="btn btn-sm btn-flat btn-secondary bg-gradient-secondary mx-1" form="manage-question" type="reset">Clear</button>
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-8">
			<div class="card card-outline card-info bg-primary">
				<div class="card-header">
					<b>Evaluation Questionnaire for Academic: <?php echo $year.' '.(ordinal_suffix($semester)) ?> </b>
					<div class="card-tools">
						<button class="btn btn-sm btn-flat btn-primary bg-gradient-success mx-1" id="eval_restrict" type="button">Evaluation Restriction</button>
						<button class="btn btn-sm btn-flat btn-success bg-gradient-success mx-1" form="order-question">Save Order</button>
					</div>
				</div>
				<div class="card-body >
					<fieldset class="border border-info p-2 w-100">
					   <legend  class="w-auto">Rating Interpretation</legend>
					   <p>5 = Outstanding, 4 = Very Satisfactory, 3 = Satisfactory, 2 = Unsatisfactory, 1 = Needs Improvement</p>
					</fieldset>
					...
					<table class="table table-condensed">
						<thead>
							<tr class="bg-gradient-success mx-1">
